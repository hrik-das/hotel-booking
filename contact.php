        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 mb-5 px-4">
                <div class="bg-white rounded shadow p-4">
                    ...
                    <h5>Address</h5>
                    <a href="<?php echo $contactResult['gmap']; ?>" target="_blank" class="d-inline-block text-dark text-decoration-none mb-2">
                        <i class="bi bi-geo-alt-fill"></i> <?php echo $contactResult["address"]; ?>
                    </a>
                    ...
                    <a href="mailto: <?php echo $contactResult['email']; ?>" class="d-inline-block text-decoration-none text-dark"><i class="bi bi-envelope-fill"></i> <?php echo $contactResult["email"]; ?></a>
                    <h5 class="mt-4">Follow Us</h5>
                    <?php
                        if($contactResult["tw"] != ""){
                            echo<<<data
                                <a href="$contactResult[tw]" class="d-inline-block fs-5 text-dark me-2">
                                    <i class="bi bi-twitter me-1"></i>
                                </a>
                            data;
                        }
                    ?>
                    <a href="<?php echo $contactResult["fb"]; ?>" class="d-inline-block fs-5 text-dark me-2">
                        <i class="bi bi-facebook"></i>
                    </a>
                    <a href="<?php echo $contactResult["insta"]; ?>" class="d-inline-block fs-5 text-dark">
